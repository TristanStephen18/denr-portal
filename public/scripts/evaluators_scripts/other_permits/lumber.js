...
function initializepage() {
  getpendingpermits("lumber_registration");
  getevaluatedpermits("lumber_registration");
  getInspectedPermits("lumber_registration");
  getRecommendedPermits("lumber_registration");
  getApprovedPermits("lumber_registration");
  getForwardedPermits('lumber_registration');
}
