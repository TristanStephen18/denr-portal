...
statusfilter.addEventListener("change", () => {
  ...
  if (statusfilter.value === "pending") {
    ...
    getpendingpermits_chainsawandtcp("tree_cutting", requirementsdiv, 'National Government Agencies');
  } else if (statusfilter.value === "evaluated") {
    typelabel.innerText = "Evaluated";
    getevaluatedpermits_chainsawandtcp("tree_cutting", requirementsdiv, evaluatedtablebody, 'National Government Agencies');
  } else {
    typelabel.innerText = "Rejected";
    getrejectedpermits_chainsawandtcp("tree_cutting", requirementsdiv, rejectedtablebody, 'National Government Agencies');
  }
